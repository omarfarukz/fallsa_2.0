      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: Icon(Icons.home, color: Colors.black), label: "Report"),
          BottomNavigationBarItem(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.all(7.0),
              child: Text(
                'Please consult your physiotherapist/doctor as soon as possible for further assessment and management.',
                style: TextStyle(
                  fontSize: 22,
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
            ...
            Center(
                child: showExercise
                    ? Text(
                        'You can watch the following exercise videos.',
                        style: TextStyle(
                          fontSize: 20,
                          color: Colors.black,
                        ),
            ...
            Padding(
                ...
                child: showExercise
                    ? Text(
                        'The view video button will link you to a 3rd party app YouTube or Web Browser.',
                        style: TextStyle(
                          fontSize: 18,
                          color: Colors.black,
                        ),
