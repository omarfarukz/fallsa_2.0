...
class ReportSTBM extends StatefulWidget {
  final score;

  ReportSTBM({this.score});

  ReportState createState() => new ReportState();
}

class ReportState extends State<ReportSTBM> {
  ...
  Widget build(BuildContext context) {
    // print('The score is: ${widget.score.toString()}');
    // print(widget.score.toString());
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Center(
                child: Text(
                  'Keputusan ujian duduk and bangun anda berbanding dengan norma populasi.',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 20,
                    color: Colors.black,
