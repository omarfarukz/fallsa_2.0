...
class _FourthQuestionState extends State<FourthQuestionBM> {
  late int jointPain;
  @override
    ...
    return Scaffold(
      ...
      body: Background(
        ...
        children: <Widget>[
          ...
          const Text(
            "Adakah anda mengalami sakit sendi?",
            style: TextStyle(
            ...
            TextButton(
                ...
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => FifthQuestionBM(
